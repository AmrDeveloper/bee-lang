...
public class CollectionModule implements BeeModule {
    ...
    private final BeeCallable collectionRemove = new BeeCallable() {
        @Override
        public int arity() {
            return 2;
        }
        ...
        public Object call(BeeInterpreter beeInterpreter, List<Object> arguments) {
            ...
            if(collection instanceof Collection) {
                Collection<Object> dataStructure = (Collection) collection;
                return dataStructure.remove(arguments.get(1));
            }
            return 0;
        }
    };

    private final BeeCallable collectionContains = new BeeCallable() {
        @Override
        public int arity() {
            return 2;
        }
        ...
        public Object call(BeeInterpreter beeInterpreter, List<Object> arguments) {
            ...
            if(collection instanceof Collection) {
                Collection<Object> dataStructure = (Collection) collection;
                return dataStructure.contains(arguments.get(1));
            }
            return 0;
        }
    };
    ...
    public void injectIntoEnvironment(Environment environment) {
        ...
        environment.define("collectionRemove", collectionRemove);
        environment.define("collectionGet", collectionGet);
        environment.define("collectionContains", collectionContains);
